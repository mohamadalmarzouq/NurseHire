...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-cyan-100" style={{ background: 'linear-gradient(180deg,#ECFEFF,#FFFFFF)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-neutral-900">ENFAS</span>
            </div>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-lg mb-4 text-neutral-900">{t('footer.contactUs')}</h3>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <Mail className="w-4 h-4 text-cyan-700" />
                <span className="text-neutral-600 text-sm">info@enfas.co</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-4 h-4 text-cyan-700" />
                <span className="text-neutral-600 text-sm">+965 94427069</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-4 h-4 text-cyan-700" />
                <span className="text-neutral-600 text-sm">Kuwait City, Kuwait</span>
              </div>
            </div>
          </div>
        </div>

        <div className="border-t border-cyan-100 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-neutral-500 text-sm">
              {t('footer.copyright')}
            </p>
            <div className="flex space-x-6">
              <Link href="/privacy" className="text-neutral-500 hover:text-cyan-700 text-sm transition-colors">
                {t('footer.privacyPolicy')}
              </Link>
              <Link href="/terms" className="text-neutral-500 hover:text-cyan-700 text-sm transition-colors">
