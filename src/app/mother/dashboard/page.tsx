    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Link href="/mother/requests" className="group nh-card nh-card--lift p-6" style={{
          ...
          <Link href="/mother/messages" className="group nh-card nh-card--lift p-6" style={{
          ...
          <Link href="/mother/calls" className="group nh-card nh-card--lift p-6" style={{
          ...
          <Link href="/mother/reviews" className="group nh-card nh-card--lift p-6" style={{
