...
export default function MotherCallsPage() {
        ...
        {calls.length === 0 ? (
          <div className="nh-card text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              Schedule a video call from a nurse profile once your request is submitted.
            </p>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-lg font-semibold text-gray-900">
                        Call with {call.caretaker?.caretakerProfile?.name || 'Nurse'}
                      </h3>
                      <span
