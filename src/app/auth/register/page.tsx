    ...
    <div className="min-h-screen" style={{background:'linear-gradient(180deg,#ECFEFF, #FFFFFF)'}}>
      <div className="nh-container" style={{minHeight:'calc(100vh - 140px)',display:'grid',alignItems:'center',padding:'40px 0'}}>
        <div className="nh-grid nh-grid-2" style={{alignItems:'stretch',gap:'24px',maxWidth:1120,margin:'0 auto'}}>
          <div className="nh-card" style={{minHeight:'520px',width:'100%',justifySelf:'stretch',borderColor:'#CFFAFE'}}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            ...
            <p className="mt-4 text-center text-sm nh-muted">{t('auth.register.alreadyHaveAccount')}{' '}<Link href="/auth/login" className="text-cyan-700 hover:text-cyan-800">{t('common.signIn')}</Link></p>
            <Link href="/" className="block mt-2 text-center text-sm nh-muted">{t('common.backToHome')}</Link>
          </div>

          {/* Benefits panel */}
          <div className="nh-card" style={{background:'linear-gradient(180deg,#ECFEFF,#FFFFFF)',borderColor:'#CFFAFE',minHeight:'520px'}}>
